...
### Week 28 April - 4 May
Tested the functionality of ESP32-CAM module and different image formats.

### Week 5 - 18 May
Worked on SPI communication between the ESP32-CAM and the STM. No success.

### Week 19 - 25 May
Continued working on the SPI protocol between the ESP32-CAM and STM, successfully achieving the transmission of the images to the PC.

### Week 26 - 28 May
Added the sequence starting button, the lights and the overall 3D model.
...
| [smart_leds](https://github.com/smart-leds-rs/smart-leds) | The end user crate for smart leds (like ws2812) | Used as a dependency for ws2812-spi |
| [ws2812_spi](https://github.com/smart-leds-rs/ws2812-spi-rs) | Use ws2812 on rust with embedded-hal spi | Used to control the lights |
